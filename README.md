...
In Kubernetes, objects are entities used to represent the desired state of the cluster. They define what applications, services, and other resources should exist, how they should behave, and what their characteristics are. Kubernetes uses these objects to manage and orchestrate the various components within a cluster. Whatever we create on cluster will be known as  Here are some commonly used Kubernetes objects:
